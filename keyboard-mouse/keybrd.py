...
kys="qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM".split()
kys2="qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM".split()
print(kys2)
for i in kys:
...
print("yops")
print(kb.read_event())
#QWERTNUISPASDFGHJKWZXCVEMqwertnuispasdfghjkwzxcvem